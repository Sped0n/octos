...
/** @brief  Clear the FMPSMBUS pending flags which are cleared by writing 1 in a specific bit.
  ...
  * @retval None
  */
#define __HAL_FMPSMBUS_CLEAR_FLAG(__HANDLE__, __FLAG__) (((__FLAG__) == FMPSMBUS_FLAG_TXE) ? ((__HANDLE__)->Instance->ISR |= (__FLAG__)) : ((__HANDLE__)->Instance->ICR = (__FLAG__)))
...
#define FMPSMBUS_GENERATE_START(__ADDMODE__, __ADDRESS__) (((__ADDMODE__) == FMPSMBUS_ADDRESSINGMODE_7BIT) ? (uint32_t) ((((uint32_t) (__ADDRESS__) & (FMPI2C_CR2_SADD)) | \
