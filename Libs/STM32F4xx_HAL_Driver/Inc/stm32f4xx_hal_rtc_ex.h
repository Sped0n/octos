...
#define IS_RTC_TAMPER_FILTER_CONFIG_CORRECT(FILTER, TRIGGER) \
    ((((FILTER) != RTC_TAMPERFILTER_DISABLE) && (((TRIGGER) == RTC_TAMPERTRIGGER_LOWLEVEL) || ((TRIGGER) == RTC_TAMPERTRIGGER_HIGHLEVEL))) || (((FILTER) == RTC_TAMPERFILTER_DISABLE) && (((TRIGGER) == RTC_TAMPERTRIGGER_RISINGEDGE) || ((TRIGGER) == RTC_TAMPERTRIGGER_FALLINGEDGE))))
