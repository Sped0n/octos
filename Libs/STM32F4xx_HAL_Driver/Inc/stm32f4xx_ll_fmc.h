...
#define FMC_PAGE_SIZE_512 (FMC_BCR1_CPSIZE_0 | FMC_BCR1_CPSIZE_1)
...
#else
#define __FMC_NAND_ENABLE(__INSTANCE__, __BANK__) (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->PCR2 |= FMC_PCR2_PBKEN) : ((__INSTANCE__)->PCR3 |= FMC_PCR3_PBKEN))
#endif /* FMC_PCR_PBKEN */
#else
#define __FMC_NAND_ENABLE(__INSTANCE__) ((__INSTANCE__)->PCR |= FMC_PCR_PBKEN)
#endif /* FMC_Bank2_3 */
...
#else
#define __FMC_NAND_DISABLE(__INSTANCE__, __BANK__) (((__BANK__) == FMC_NAND_BANK2) ? CLEAR_BIT((__INSTANCE__)->PCR2, FMC_PCR2_PBKEN) : CLEAR_BIT((__INSTANCE__)->PCR3, FMC_PCR3_PBKEN))
#endif /* FMC_PCR_PBKEN */
#else
#define __FMC_NAND_DISABLE(__INSTANCE__, __BANK__) CLEAR_BIT((__INSTANCE__)->PCR, FMC_PCR_PBKEN)
#endif /* FMC_Bank2_3 */
...
/**
  ...
  */
#if defined(FMC_Bank2_3)
#define __FMC_NAND_ENABLE_IT(__INSTANCE__, __BANK__, __INTERRUPT__) (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 |= (__INTERRUPT__)) : ((__INSTANCE__)->SR3 |= (__INTERRUPT__)))
#else
...
/**
  ...
  */
#if defined(FMC_Bank2_3)
#define __FMC_NAND_DISABLE_IT(__INSTANCE__, __BANK__, __INTERRUPT__) (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 &= ~(__INTERRUPT__)) : ((__INSTANCE__)->SR3 &= ~(__INTERRUPT__)))
#else
...
/**
  ...
  */
#if defined(FMC_Bank2_3)
#define __FMC_NAND_GET_FLAG(__INSTANCE__, __BANK__, __FLAG__) (((__BANK__) == FMC_NAND_BANK2) ? (((__INSTANCE__)->SR2 & (__FLAG__)) == (__FLAG__)) : (((__INSTANCE__)->SR3 & (__FLAG__)) == (__FLAG__)))
#else
...
/**
  ...
  */
#if defined(FMC_Bank2_3)
#define __FMC_NAND_CLEAR_FLAG(__INSTANCE__, __BANK__, __FLAG__) (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 &= ~(__FLAG__)) : ((__INSTANCE__)->SR3 &= ~(__FLAG__)))
#else
