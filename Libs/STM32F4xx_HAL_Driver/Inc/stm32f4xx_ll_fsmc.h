...
#define FSMC_PAGE_SIZE_512 (FSMC_BCR1_CPSIZE_0 | FSMC_BCR1_CPSIZE_1)
...
/**
  ...
  * @retval None
  */
#define __FSMC_NAND_ENABLE(__INSTANCE__, __BANK__) (((__BANK__) == FSMC_NAND_BANK2) ? ((__INSTANCE__)->PCR2 |= FSMC_PCR2_PBKEN) : ((__INSTANCE__)->PCR3 |= FSMC_PCR3_PBKEN))
...
/**
  ...
  * @retval None
  */
#define __FSMC_NAND_DISABLE(__INSTANCE__, __BANK__) (((__BANK__) == FSMC_NAND_BANK2) ? CLEAR_BIT((__INSTANCE__)->PCR2, FSMC_PCR2_PBKEN) : CLEAR_BIT((__INSTANCE__)->PCR3, FSMC_PCR3_PBKEN))
...
/**
  ...
  * @retval None
  */
#define __FSMC_NAND_ENABLE_IT(__INSTANCE__, __BANK__, __INTERRUPT__) (((__BANK__) == FSMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 |= (__INTERRUPT__)) : ((__INSTANCE__)->SR3 |= (__INTERRUPT__)))
...
/**
  ...
  * @retval None
  */
#define __FSMC_NAND_DISABLE_IT(__INSTANCE__, __BANK__, __INTERRUPT__) (((__BANK__) == FSMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 &= ~(__INTERRUPT__)) : ((__INSTANCE__)->SR3 &= ~(__INTERRUPT__)))
...
/**
  ...
  */
#define __FSMC_NAND_GET_FLAG(__INSTANCE__, __BANK__, __FLAG__) (((__BANK__) == FSMC_NAND_BANK2) ? (((__INSTANCE__)->SR2 & (__FLAG__)) == (__FLAG__)) : (((__INSTANCE__)->SR3 & (__FLAG__)) == (__FLAG__)))
...
/**
  ...
  * @retval None
  */
#define __FSMC_NAND_CLEAR_FLAG(__INSTANCE__, __BANK__, __FLAG__) (((__BANK__) == FSMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 &= ~(__FLAG__)) : ((__INSTANCE__)->SR3 &= ~(__FLAG__)))
