...
#define IS_LL_RCC_SAI_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_SAI1_A_CLKSOURCE) || ((__VALUE__) == LL_RCC_SAI1_B_CLKSOURCE))
...
#define IS_LL_RCC_DFSDM_AUDIO_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_DFSDM1_AUDIO_CLKSOURCE) || ((__VALUE__) == LL_RCC_DFSDM2_AUDIO_CLKSOURCE))
...
#define IS_LL_RCC_I2S_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_I2S1_CLKSOURCE) || ((__VALUE__) == LL_RCC_I2S2_CLKSOURCE))
#else
